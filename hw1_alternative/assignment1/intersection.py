...
def ray_mesh_intersection(mesh: Trimesh, ray_origins: np.ndarray, ray_directions: np.ndarray,
    ...
    while True:
        ...
        # TODO: replace the following line with calling a function from scene
        # hint: you might find this link useful:
        # https://github.com/mikedh/trimesh/blob/8e24a5f9d547ed72be4438e069bd44a5eaddc183/trimesh/ray/ray_pyembree.py#L342
        query = np.array([-1 for _ in current_indices])
